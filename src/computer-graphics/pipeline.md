...
在实时渲染领域中也能找到这样的流水线结构，一种粗略的划分是将渲染管线分为引用阶段
、几何处理阶段、光栅化阶段和像素处理阶段。

![stage](/images/computer-graphics/stage.png)
...
![geometry](/images/computer-graphics/geometry.png)
...
![view transform](/images/computer-graphics/view-transform.png)

_上图中假设相机进行的是透视观察，然后对观察位置和方向进行了变换。_
...
![projection](/images/computer-graphics/projection.png)
...
![clipping](/images/computer-graphics/clipping.png)
...
![screen-mapping](/images/computer-graphics/screen-mapping.png)
...
![sync](/images/computer-graphics/sync.png)
...
![texturing](/images/computer-graphics/texturing.png)
...
- [容易混淆的 Clip Space vs NDC，透视除法 - 知乎](https://zhuanlan.zhihu.com/p/65969162)
- [Unity-InterviewQuestion/图形学.md at master · Lafree317/Unity-InterviewQuestion](https://github.com/Lafree317/Unity-InterviewQuestion/blob/master/%E5%9B%BE%E5%BD%A2%E5%AD%A6.md)
- [LearnOpenGL 学习笔记—入门 07：Coordinate Systems_opengl vcoordinate-CSDN 博客](https://blog.csdn.net/weixin_43803133/article/details/107577635)
