...
![CRT](/images/computer-graphics/crt.png)
...
![Scan](/images/computer-graphics/scan.png)
...
![Random](/images/computer-graphics/random.png)
...
显示彩色图形的一种方法是在屏幕上涂上多层不同的荧光粉。发射颜色由电子束在荧光层中的穿透深度决定。这种方法称为**电子束穿透法**，它常用于红、绿两层结构。

速度慢的电子束只激活外面的红色层，速度快的电子束能穿过红色层并激活里面的绿色层。而中速的电子束通过发射红、绿光的组合来生成两种另外的颜色：橙色和黄色。

**荫罩法**常用于光栅扫描系统（包括彩色电视机），此方法基于我们熟悉的由红、绿、蓝三原色来组合颜色的原理，称它为 RGB 颜色模型。
...
![Shadow mask](/images/computer-graphics/shadow-mask.png)
...
![Passive matrix](/images/computer-graphics/passive-matrix.png)
...
![Observation equipment](/images/computer-graphics/3d-observation-equipment.png)
...
![Raster scanning system](/images/computer-graphics/raster-scanning-system.png)
...
![Video controller](/images/computer-graphics/video-controller.png)
...
![Video controller](/images/computer-graphics/with-show-video-controller.png)
